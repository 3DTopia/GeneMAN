...
class BaseLift3DSystem(BaseSystem):
    ...
    class Config(BaseSystem.Config):
        ...
        guidance_add_type: str = ""
        guidance_add: dict = field(default_factory=dict)

        # guidance_type_rgb: str = ""
        # guidance_rgb: dict = field(default_factory=dict)

        prompt_processor_type: str = ""
        prompt_processor: dict = field(default_factory=dict)

        prompt_processor_add_type: str = ""
        prompt_processor_add: dict = field(default_factory=dict)

        # prompt_processor_type_rgb: str = ""
        # prompt_processor_rgb: dict = field(default_factory=dict)
